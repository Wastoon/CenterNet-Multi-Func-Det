...
if __name__ == '__main__':
    ...
    img_train_dir = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/train'
    img_test_dir = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/val'
    img_common_set = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/commonsubset'
    img_challenge_set = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/challengesubset'
    img_full_set = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/fullset'
    anno_dir = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/annotations'

    img_AAAI_train_dir = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/AAAI_train'
    img_AAAI_test_dir = '/data1/mry/datasets/landmark-datasets/300W/paper_public_use/images/AAAI_val'
