...
def deepfashion2coco(input_annos_dir, input_imgs_dir, output_annos):
    dataset = {
        "info": {},
        "licenses": [],
        "images": [],
    ...
    imgs_list = os.listdir(input_imgs_dir)
    num_images = len(imgs_list)
    for num in tqdm(range(1, num_images + 1)):
        json_name = os.path.join(input_annos_dir, str(num).zfill(6) + '.json')
        image_name = os.path.join(input_imgs_dir, str(num).zfill(6) + '.jpg')
    ...
    json_name = output_annos
    with open(json_name, 'w') as f:
        json.dump(dataset, f)

if __name__=='__main__':
    input_train_annos_dir = '/data1/mry/datasets/deepfashion2/test/train/annos'
    input_train_imgs_dir = '/data1/mry/datasets/deepfashion2/test/train/image'
    #input_val_annos_dir = '/data1/mry/datasets/deepfashion2/validation/annos'
    #input_val_imgs_dir = '/data1/mry/datasets/deepfashion2/validation/image'
    output_train_annos = '/data1/mry/datasets/deepfashion2_coco/annotations/deepfashion_train.json'
    output_val_annos = '/data1/mry/datasets/deepfashion2_coco/annotations/deepfashion_val.json'

    #val transformation
    deepfashion2coco(input_train_annos_dir, input_train_imgs_dir, output_train_annos)